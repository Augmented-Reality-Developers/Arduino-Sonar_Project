...
if (degree <= 1) {                  // if at the far right then set motion = 1/ true we're about to go right to left
motion = 0;                         // this changes the animation to run right to left
}
if (degree >= 179) {                    // if servo at 0 degrees then we're about to go left to right
motion = 1;                         // this sets the animation to run left to right
}
